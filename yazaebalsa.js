    ...
    [3], {
            ...
            function a() {
                return {
                    translation: {
                        ...
                        play: "Играть",
                        user_overdraw_f: " закрасила вашу пиксель",
                        user_overdraw_m: " закрасил вашу пиксель",
            ...
            function K() {
                return function (e, t) {
                    var n, a, r = t().Game,
                        ...
                        m = r.channel,
                        h = r.deadline;
                    p || h ? e(h ? Object(d.i)() : Object(d.k)()) : m && m.isFreeze(s, u) ? e(Object(d.j)()) : _ ? _ === c.f ? e(function (e, t) {
                        return function (n, a) {
                            var r = a().Game,
                                s = r.channel,
                                u = r.color,
                        ...
                        return function (n, a) {
                            ...
                            s && (s.sendPixel(p), null === X && (n(function e() {
                                return function (t, n) {
                                    if (n().Game.pixelSecond <= 0) return t(me(c.e)), t({
                                        type: S,
                                        lock: 0
                                ...
                                type: B
                            }), d <= 1 && (X = null, clearTimeout(X), n(me(c.e)), n({
                                type: S,
                                lock: 0
                            }), n(Z(null))), n(V()))
                        }
                        ...
                        c && (c.getColorIdAt(n, a) === u.replace("#000000", "#0").replace("#074BF3", "#74BF3") ? _ || e(Object(d.l)()) : (c.pushMyDot(n, a), c.sendPixel(m), e(ae(s)), e(V())))
                    }))
                }
            }
            t.a = function e() {
                ...
                switch (a.type) {
                    ...
                    case T:
                        return (n = h({}, n, Object(r.a)({}, a.score, Math.max(n[a.score] - 1, 0)))).selectedTool === a.score && 0 === n[a.score] && (n.selectedTool = null), n;
                    case x:
                        return h({}, n, {
                            root: a.root
                        });
                    ...
                    case y:
                        return h({}, n, (t = {}, Object(r.a)(t, c.e, a[c.e]), Object(r.a)(t, c.c, a[c.c]), Object(r.a)(t, c.d, a[c.d]), Object(r.a)(t, c.f, a[c.f]), Object(r.a)(t, "usageLost", a.usageLost), t));
                    case w:
                        return n.changeToolLock ? n : h({}, n, {
                            selectedTool: a.tool,
                    ...
                    case E:
                        return n.selectedTool && n.selectedTool !== c.e ? h({}, n, {
                            color: a.color,
                            selectedTool: null
                        }) : h({}, n, {
                            color: a.color
        ...
        161: function (e, t, n) {
                ...
                F = function (e) {
                    ...
                    return Object(k.a)(t, e), Object(O.a)(t, [{
                        ...
                        value: function () {
                            ...
                            }, M.a.t("close"))) : null)), !t || this.isNetwork() || r ? null : s.a.createElement(N, {
                                showCross: !0,
                                onClose: function () {
                                    return e.toggleDetails()
                                }
                ...
                qe = function (e) {
                    ...
                    return Object(k.a)(t, e), Object(O.a)(t, [{
                        ...
                        value: function () {
                            ...
                            if (a) return s.a.createElement(F, {
            ...
            var pt = Object(E.b)((function (e) {
                ...
                mt = (n(464), n(465), n(466), function (e) {
                    function t() {
                        return Object(g.a)(this, t), Object(w.a)(this, Object(y.a)(t).apply(this, arguments))
                    }
                    return Object(k.a)(t, e), Object(O.a)(t, [{
                    ...
                    return Object(k.a)(t, e), Object(O.a)(t, [{
                        ...
                        value: function () {
                            ...
                            return this.state.null ? s.a.createElement("div", null) : this.props.duplicateConnect ? s.a.createElement(Pe, null) : s.a.createElement("div", {
                                ...
                                desktop: !0
                            }), this.props.view ? null : s.a.createElement(Fe, {
                                onDoubleClick: Wt,
                                desktop: !0
                    ...
                    return Object(r.a)(e, null, [{
                        ...
                        value: function (t) {
                            return new Promise((function (a, r) {
                                ...
                                e.lang = t, o.hasOwnProperty(t) ? e.initI18n(t, o).then(a).catch(r) : n(416)("./" + t).then((function (n) {
        ...
        5: function (e, t, n) {
            ...
            var y = function (e) {
                return e <= 59 ? "0:".concat(w(e)) : Math.floor(e / 60) + ":" + w(e % 60)
            };
            ...
            function T(e) {
                ...
                for (var n = e.split("\n"), a = n.length, r = [], o = 0; o < a; o++) r.push(x(n[o], o, t)), o !== a - 1 && r.push(c.a.createElement("br", {
                    key: o
                }));
                return r
            }
            ...
            function K(e, t) {
                ...
                return null === W ? l.a.getAuthToken("friends").then((function (a) {
                    return W = a, K(e, t, n)
                })).catch((function (e) {
                    throw G(e, "getAuthToken: ")
                })) : (t.v || (t.v = "5.95"), t.access_token = W.access_token, l.a.callAPIMethod(e, t).then((function (e) {
            ...
            function X() {
                ...
                e || (e = "https://vk.com/app" + l.a.getStartParams().appId, l.a.getStartParams().groupId && (e += "_-" + l.a.getStartParams().groupId)), null !== t && (e += "#" + t), l.a.share(e).catch(j)
            }

            function q(e, t, n, a, r, o, i, c) {
                if (a) {
            ...
            function J() {
                return l.a.storageGet([Q]).then((function (e) {
            ...
            function $() {
                l.a.storageSet(Q, Z).catch((function (e) {
                    j()
                }))
            }
            ...
            function ee() {
                ...
                return void 0 !== e && (V = e), !l.a.getStartParams().appId || V
            }
            ...
            function ne() {
                return (ne = Object(o.a)(r.a.mark((function e() {
                    var t;
                    return r.a.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
                                return e.prev = 0, window.fdx19 = function (e) {
                                    ...
                                    ts: Date.now(),
                                    vks: l.a.startSearch
                                }, e.next = 6, re("https://pixel-dev.w84.vkforms.ru/js/main.72a7db0d.chunk.js?" + m.a.stringify(t));
                            case 6:
                                e.next = 11;
                                break;
                            case 8:
            ...
            function oe() {
                return (oe = Object(o.a)(r.a.mark((function e(t) {
                    var n;
                    return r.a.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            case 0:
